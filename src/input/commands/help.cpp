...
void Editor::show_command_help(const std::string &topic_text)
{
  ...
  std::vector<std::string> lines = {
      ...
      "  Alt+Shift+D/B    Add a cursor on the line below / above",
      "  Alt+Shift+S      One cursor per line of the selection",
      "  Alt+Shift+M      Select every occurrence of the selection",
      "  Alt+Shift+K/P    Keep only the primary / make the next one primary",
      ...
      "  Alt+Shift+Q        Close current pane",
