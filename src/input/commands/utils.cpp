...
namespace CommandLineUtils
{
  ...
  bool command_takes_argument(const std::string &cmd)
  {
    ...
    return lc == "e" || lc == "edit" || lc == "open" || lc == "w" || lc == "write" || lc == "wq"
           || lc == "x" || lc == "xit" || lc == "theme" || lc == "colorscheme" || lc == "colo"
           || lc == "line" || lc == "goto" || lc == "wincmd" || lc == "task" || lc == "tasknew"
           || lc == "openrecent" || lc == "autosave" || lc == "help" || lc == "h" || lc == "gitdiff"
           || lc == "gitdiffstaged" || lc == "gitstage" || lc == "gitunstage" || lc == "gitcommit"
           || lc == "find" || lc == "ff" || lc == "grep" || lc == "projectsearch"
           ...
           || lc == "cppimpl" || lc == "cpppair" || lc == "tsinstall" || lc == "treesitterinstall"
  ...
  bool parse_line_col(const std::string &s, int &line_out, int &col_out)
  {
    ...
    std::string col_part = (colon == std::string::npos) ? "" : s.substr(colon + 1);
