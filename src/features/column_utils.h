...
inline int compute_visual_column(const std::string &line, int logical_col, int tab_size)
{
...
inline std::vector<int> build_visual_columns(const std::string &line, int tab_size)
{
  return build_visual_columns(line, tab_size, (int)line.size());
}

inline int visual_to_logical_column(const std::string &line, int visual_col, int tab_size)
{
